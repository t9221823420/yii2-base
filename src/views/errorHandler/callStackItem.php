...
<li class="<?= ($index === 1 || !$handler->isCoreFile($file)) ? 'application' : '' ?> call-stack-item"
    ...
    <div class="element-wrap">
        <div class="element">
            ...
            <span class="text"><a onclick="event.stopPropagation();" href="ide://open?url=file://<?= $file !== null ? $file : '' ?>&line=<?= $line !== null ? $line + 1 : '' ?>"><?= $file !== null ? 'in ' . $handler->htmlEncode($file) : '' ?></a></span>
            <span class="at">
                <?= $line !== null ? 'at line' : '' ?>
